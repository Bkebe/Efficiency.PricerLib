...
public:
	...
	virtual ~MustSwaption(){}

	virtual Real price();
	boost::shared_ptr<PricingEngine> setEngineQuantLibLMM();
	boost::shared_ptr<PricingEngine> setEngineQuantLibBlackFT();
	boost::shared_ptr<PricingEngine> setEngineQuantLibHullWhite();
