...
void SwapFixedLeg::setComponent(std::vector<std::tuple<Date, Date, Real>>  FixedRates, DayCounter FixedLegDayCounter, Frequency FixedLegFrequency)
		{
		//	SwapFixedLeg::fixedRates = new std::vector<std::tuple<Date, Date, Real>>();
...
{
	this->fixedRates.operator=(fixedRates);
}
...
std::vector<Real> SwapFixedLeg::fixedRatesFreq(std::vector<std::tuple<Date, Date, Real>> matrixRate, Date settlementDate, Date maturity, Frequency fixedLegFrequency)
{
